...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _sendCode() async {
    ...
    try {
      await AuthService.instance.requestPasswordResetPin(email);
      if (!mounted) return;
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      await AuthService.instance.resetPasswordWithPin(
        email: email,
        pin: pin,
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Enter your admin email to receive a 6-digit PIN, then set a new password.',
