...
import { getAdminSupportSummary, getSupportTicketTimeline, listAdminSupportTickets, updateAdminSupportTicket } from '../../controllers/chatController';
import { listDeletionReminders, processDueDeletionRequests } from '../../controllers/userAccountController';
import { sendBroadcastNotification } from '../../controllers/adminNotificationController';
...
export const adminRoutes = async (app: FastifyInstance) => {
    ...
    app.get('/support/tickets/:id/timeline', { preHandler: [requireAdmin] }, getSupportTicketTimeline as any);
    app.patch('/support/tickets/:id', { preHandler: [requireAdmin] }, updateAdminSupportTicket as any);
    app.post('/notifications/broadcast', { preHandler: [requireAdmin] }, sendBroadcastNotification as any);
