...
- Live active-order dashboard with notification broadcast alerts for platform updates
...
- Notifications inbox with device token registration and platform announcement support
- Scheduled order visibility in the queue
- Productivity-focused queue interactions

## Productivity Baseline (Current)

- Notification broadcast alert card on dashboard for platform updates and announcements (deep-links to `/notifications`)
