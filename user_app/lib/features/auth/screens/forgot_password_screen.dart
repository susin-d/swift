...
class _ForgotPasswordScreenState extends ConsumerState<ForgotPasswordScreen> {
  ...
  Future<void> _sendCode() async {
    ...
    try {
      await ref.read(authServiceProvider).requestPasswordResetPin(email);
      if (!mounted) return;
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      await ref.read(authServiceProvider).resetPasswordWithPin(
            email: email,
            pin: pin,
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Enter your email to receive a 6-digit PIN, then set a new password.',
